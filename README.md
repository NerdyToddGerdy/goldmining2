...
Early development. A browser game (TypeScript, Vite, PixiJS). **Play it at https://nerdytoddgerdy.github.io/goldmining2/** (redeployed automatically from `main`); an itch.io release is planned. The first playable target is the **Home Creek**: a standalone shovel-and-pan level that is also where you return after going broke.
